...
namespace CarLife.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240305204108_EditOfCaryYearOfManufecture")]
    partial class EditOfCaryYearOfManufecture
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarLife.Core.Entities.Car", b =>
                {
                    ...
                    b.Property<DateOnly>("YearOfManufecture")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CarLife.Core.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
